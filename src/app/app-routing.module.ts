...
const routes: Routes = [
  ...
  {
    path: 'menu-customer',
    loadChildren: () => import('./menu/customer-menu/customer-menu.module').then( m => m.CustomerMenuPageModule)
  },
  {
    path: 'about-us',
  ...
  {
    path: 'view-category-product',
    loadChildren: () => import('./view-category-product/view-category-product.module').then( m => m.ViewCategoryProductPageModule)
  },
  {
    path: 'order',
